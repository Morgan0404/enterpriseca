...
class TestRecognition(unittest.TestCase):
    ...
    def setUp(self):
        # Preload the catalogue with the expected track.
        # This track corresponds to the audio file used in the recognition test.
        track_data = {
            "title": "Don't Look Back In Anger",
            "artist": "Oasis",
            "file_path": "/Users/morgan/Desktop/EnterprsieCA/full/Don't Look Back In Anger.wav"
        }
        # Attempt to add the track. (If it already exists, you might ignore the error.)
    ...
    def test_recognize_valid_audio(self):
        ...
        with open("frag/_Dont Look Back In Anger.wav", "rb") as audio_file:
            ...
            # Use testmode=true to return the full encoded string (no truncation)
        ...
        # Verify required keys in the 'track' object.
        ...
        # Check that the decoded audio is non-empty.
